...
static const CGFloat CSToastCornerRadius        = 9.0;    //3
static const CGFloat CSToastOpacity             = 0.9;   //0.8
static const CGFloat CSToastFontSize            = 15.0;   //15
static const CGFloat CSToastMaxTitleLines       = 0;
static const CGFloat CSToastMaxMessageLines     = 0;
static const NSTimeInterval CSToastFadeDuration = 0.2;

// shadow appearance
static const CGFloat CSToastShadowOpacity       = 0.8;   //0.8
...
//    toast.center = [self centerPointForPosition:point withToast:toast];
    ...
    CGPoint toastCenterPoint = [self centerPointForPosition:point withToast:toast];
    
    CGPoint newToastCenterPoint = CGPointMake(toastCenterPoint.x, toastCenterPoint.y / 2 + 30.0);
    
    toast.center = newToastCenterPoint;
...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast {
    if([point isKindOfClass:[NSString class]]) {
        ...
        if([point caseInsensitiveCompare:@"top"] == NSOrderedSame) {
            ...
            return CGPointMake(self.bounds.size.width / 2, (self.bounds.size.height / 1.5)-80);
        }
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (message != nil) {
        ...
        messageLabel.frame = CGRectMake(0.0, 0.0, expectedSizeMessage.width + 16, expectedSizeMessage.height);
    }
